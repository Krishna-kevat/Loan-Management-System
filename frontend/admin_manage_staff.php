...
// Fetch only Managers
$sql = "SELECT * FROM staff_registration WHERE role = 'Manager' ORDER BY fullname ASC";
...
<head>
    ...
    <title>Staff Management | Purwase Admin</title>
    ...
    <style>
        ...
        .role-officer { background: rgba(16, 185, 129, 0.1); color: #10b981; }
...
<div class="layout-wrapper">
  ...
  <div class="container" style="max-width: 1600px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <div>
            ...
            <p style="color: var(--text-muted);">System administrators can add, update, and block regional managers.</p>
        </div>
        <button class="btn btn-primary" onclick="openModal('addStaffModal')">+ Add Manager</button>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                if (!$result || mysqli_num_rows($result) === 0) {
                    echo "<tr><td colspan='6' style='text-align:center; padding:3rem;'>No staff records found.</td></tr>";
                } else {
                        ...
                        echo "<tr>
                            ...
                            <td>
                                <div style='display:flex; gap:0.5rem;'>
                                    ...
                                    <a href='../backend/actions/staff_management_actions.php?action=delete&staff_id=".$row['staff_id']."' class='btn btn-sm' style='background:rgba(239, 68, 68, 0.1); color:#ef4444; border:1px solid rgba(239, 68, 68, 0.2);' onclick='return confirm(\"Are you sure you want to delete this manager?\")'>Delete</a>
                                </div>
                            </td>
                        </tr>";
                    }
  ...
  <div id="addStaffModal" class="modal">
    <div class="modal-content">
        <h3 style="color: var(--text-main);">Provision Manager Account</h3>
        <form action="../backend/actions/staff_management_actions.php?action=add" method="POST" style="margin-top: 1.5rem;">
            <div class="grid" style="grid-template-columns: 1fr 1fr; gap: 1rem;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="Manager" readonly style="background: var(--border); cursor: not-allowed;">
                </div>
                <div class="form-group">
            ...
            <div style="display:flex; justify-content:flex-end; gap:1rem; margin-top:2rem;">
                ...
                <button type="submit" class="btn btn-primary">Create Manager Account</button>
            </div>
        </form>
    </div>
  </div>
  ...
  <div id="editStaffModal" class="modal">
    <div class="modal-content">
        <h3 style="color: var(--text-main);">Modify Manager Details</h3>
    ...
    <div class="modal-content" style="max-width: 400px;">
        ...
        <form action="../backend/actions/staff_management_actions.php?action=reset_pwd" method="POST" style="margin-top: 1.5rem;">
            ...
            <div style="display:flex; justify-content:flex-end; gap:1rem; margin-top:2rem;">
                ...
                <button type="submit" class="btn btn-primary" style="background:var(--accent);">Update Password</button>
            </div>
        </form>
    </div>
  </div>
