...
<head>
    ...
    <title>Loan Approvals | Purwase Manager</title>
...
<div class="layout-wrapper">
  ...
  <div class="container" style="max-width: 1600px;">
    <div class="hero" style="padding: 2rem 0; text-align: left;">
      ...
      <p style="color: var(--text-muted);">Review and finalize loan applications vetted by loan officers.</p>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) == 0) {
                    echo "<tr><td colspan='8' style='text-align:center; padding: 4rem; color: var(--text-muted);'>No applications pending manager approval</td></tr>";
                } else {
                        ...
                        echo "</td>
                            ...
                            <td>
                                <div style='display:flex; gap:0.5rem;'>
                                    <a class='action-btn btn-approve' href='manager_loan_approval.php?action=approve&Loan_id={$row['Loan_id']}'>Approve</a>
                                    <a class='action-btn btn-reject' href='manager_loan_approval.php?action=reject&Loan_id={$row['Loan_id']}'>Reject</a>
                                </div>
                            </td>
                        </tr>";
                    }
  ...
  <footer>
    <p>&copy; 2025 Purwase Company | Managerial Approval System</p>
  </footer>
