...
// Fetch only Loan Officers
$sql = "SELECT * FROM staff_registration WHERE role = 'Loan Officer' ORDER BY fullname ASC";
...
<head>
    ...
    <title>Manage Loan Officers | Purwase Manager</title>
    ...
    <style>
        ...
        .role-loan-officer { background: rgba(16, 185, 129, 0.1); color: #10b981; }
...
<div class="layout-wrapper">
  ...
  <div class="container" style="max-width: 1600px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <div>
            <h2>🔍 Loan Officer Management</h2>
            <p style="color: var(--text-muted);">Managers can oversee loan officers, approve access, or block accounts.</p>
        </div>
        <button class="btn btn-primary" onclick="openModal('addStaffModal')">+ Add Loan Officer</button>
    </div>
        ...
        <table>
            ...
            <tbody>
                ...
                if (!$result || mysqli_num_rows($result) === 0) {
                    echo "<tr><td colspan='6' style='text-align:center; padding:3rem;'>No loan officer records found.</td></tr>";
                } else {
                        ...
                        echo "<tr>
                            ...
                            <td>
                                <div style='display:flex; gap:0.5rem;'>
                                    ...
                                    <a href='../backend/actions/staff_management_actions.php?action=delete&staff_id=".$row['staff_id']."' class='btn btn-sm' style='background:rgba(239, 68, 68, 0.1); color:#ef4444; border:1px solid rgba(239, 68, 68, 0.2);' onclick='return confirm(\"Are you sure you want to delete this officer?\")'>Delete</a>
                                </div>
                            </td>
                        </tr>";
                    }
  ...
  <div id="addStaffModal" class="modal">
    <div class="modal-content">
        <h3 style="color: var(--text-main);">Provision Loan Officer Account</h3>
        <form action="../backend/actions/staff_management_actions.php?action=add" method="POST" style="margin-top: 1.5rem;">
            <div class="grid" style="grid-template-columns: 1fr 1fr; gap: 1rem;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="Loan Officer" readonly style="background: var(--border); cursor: not-allowed;">
                </div>
                <div class="form-group">
  ...
  <div id="editStaffModal" class="modal">
    <div class="modal-content">
        <h3 style="color: var(--text-main);">Modify Officer Details</h3>
